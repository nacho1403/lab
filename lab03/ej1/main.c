...
int main(int argc, char *argv[]) {
    ...
    printf("1) La temperatura minima absoluta es: %d\n", absolute_min_temp);

    printf("2) Temperatura maxima por año: \n");
    dump_year_temp_array(maxes);

    printf("3) Mes de maxima precipitacion por año:\n");
    dump_year_month_array(max_rainfalls);

    /* show the ordered array in the screen */
    printf("Los datos igual que en el archivo de entrada\n");
    array_dump(array);
